<%@ Page Title="" Language="C#" MasterPageFile="~/MasterFrontPage.master" AutoEventWireup="true" CodeFile="MSIVOpAdd.aspx.cs" Inherits="MSIV_MSIVOpAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FrontEndPlaceHoder" Runat="Server">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnNew" runat="server" Text="New" 
                    PostBackUrl="~/MSIV/MSIVNewOp.aspx" />
            </td>
            <td>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [OP_ID], [OP_NAME] FROM [OPORD] WHERE ([OP_LVL] = 4)">
    </asp:SqlDataSource>
